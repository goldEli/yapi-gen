  ...
  const options = {
    ...
    tooltip: {
      ...
      pointFormat: props.titleType
        ? '<span style="display:inline-block;width:8px;height:8px;borderRadius:50%;background:#43BA9A;"></span><span style="marginLeft:8px;fontSize:12px,color:#646566">任务：{point.y}项</span></div>'
        : '<span style="display:inline-block;width:8px;height:8px;borderRadius:50%;background:#43BA9A;"></span><span style="marginLeft:8px;fontSize:12px,color:#646566">任务：{point.y}%</span></div>',
      footerFormat: '</div>',
      shared: true,
      useHTML: true,
    },
