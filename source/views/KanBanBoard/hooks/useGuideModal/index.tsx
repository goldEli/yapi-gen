  ...
  const inform = [
    {
      ...
      img: 'https://mj-system-1308485183.cos.accelerate.myqcloud.com/public/2.7.1/kanban1.jpg',
    },
    {
      key: 1,
      title: t('grouped_view'),
      desc: t('at_the_same_time'),
      img: 'https://mj-system-1308485183.cos.accelerate.myqcloud.com/public/2.7.1/kanban2.jpg',
    },
    {
      key: 2,
      ...
      img: 'https://mj-system-1308485183.cos.accelerate.myqcloud.com/public/2.7.1/kanban3.jpg',
    },
  ]
  const guildModalEl = (
    <GuideModal
