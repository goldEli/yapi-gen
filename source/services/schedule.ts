    ...
    data: {
      list: [
        ...
        },
        {
          id: 7,
          title: '这是一个全天任务',
          startTime: Date.parse('2023-3-26 6:45:00'),
          endTime: Date.parse('2023-3-26 7:30:00'),
          color: '#00D2C5',
          is_all_day: 1,
        },
        {
          ...
          endTime: Date.parse('2023-3-28 7:30:00'),
          color: '#00D2C5',
          is_all_day: 1,
        },
        {
        ...
        },
        {
          id: 10,
          title: '这是一个全天任务',
          startTime: Date.parse('2023-3-28 6:45:00'),
          endTime: Date.parse('2023-3-28 7:30:00'),
          color: '#00D2C5',
          is_all_day: 1,
        },
        {
          id: 11,
          title: '这是一个全天任务',
          startTime: Date.parse('2023-3-29 6:45:00'),
          endTime: Date.parse('2023-3-29 7:30:00'),
          color: '#00D2C5',
          is_all_day: 1,
        },
        {
