  ...
  const modelMethods = [
    {
      ...
      update: batchEdit,
      del: batchDelete,
      checkboxText: t('deleteTheCorrespondingAtTheChildDemand'),
      text: t('theCheckedRequirementsWillBeAreYouSureTo'),
    },
    {
      type: 2,
      ...
      del: batchFlawDelete,
      checkboxText: t('deleteTheCorrespondingAtTheSameTime'),
      text: t('theCheckedDefectsWillBeAreYouSureTo'),
    },
    {
      type: 3,
      ...
      checkboxText: t('deleteTheCorrespondingSubtransactionAtTheSameTime'),
      text: t('theSelectedTransactionWillBeConfirmTo'),
    },
  ]
